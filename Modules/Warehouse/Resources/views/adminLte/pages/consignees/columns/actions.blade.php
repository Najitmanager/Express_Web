...
<div class="btn-group" role="group" aria-label="Actions">
    ...
    <div class="dropdown-menu custom-drodown-content" aria-labelledby="dropdownMenuButton">
        ...
        @if (/*auth()->user()->can('edit-currencies') ||*/ $user_role == $admin)
            <div>
                <a href="#" class="btn btn-sm btn-action-table px-3" data-href="{{ fr_route('consignees.edit', $model->id) }}" id="edit-{{ $model->id }}"
        ...
        {{--    @if ($model->id != 1) --}}
        <div>
            <button type="button" data-action="{{ fr_route('consignees.destroy', $model->id) }}"
