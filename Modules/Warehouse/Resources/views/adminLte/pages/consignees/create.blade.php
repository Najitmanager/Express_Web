...
@section('pageTitle')
    {{ __('warehouse::view.create_new_consignee') }}
@endsection
...
@section('content')
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header">
            ...
            <h3 class="fw-bolder m-0">{{ __('warehouse::view.create_new_consignee') }}</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <div>
            <!--begin::Form-->
            <form id="kt_account_profile_details_form" class="form" action="{{ fr_route('consignees.store') }}" method="post" enctype="multipart/form-data">
                <!--begin::Card body-->
