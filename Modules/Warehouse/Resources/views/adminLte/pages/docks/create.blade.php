    ...
    <div class="card table-card-wrapper">
        ...
        <form id="kt_account_profile_details_form" class="form" action="{{ fr_route('docks.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="d-flex justify-content-between p-2 flex-wrap gap-2 border-bottom border-secodary">
                ...
                <a href="{{ route('docks.index') }}" class="btn btn-sm btn-light px-2 d-flex align-items-center">
                        ...
                        <div class="row justify-content-center align-items-center">
                            <div class="col-lg-12">
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-9">
                                        <select name="client_id" id="client" class="form-select form-select-sm" aria-label="Small select example">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-9">
                                        <select name="port_id" id="port" class="form-select form-select-sm" aria-label="Small select example">
                ...
                <div class="tab-content" id="tabContent">
                    ...
                    <div class="tab-pane fade show active" id="tab1" role="tabpanel">
                        <div class="d-flex justify-content-between p-2 flex-wrap gap-2">
                            <button type="button" class="btn btn-sm btn-light px-2 d-flex align-items-center" id="add-vehicle" data-toggle="modal"
            ...
            <div class="modal-content">
                ...
                <div class="p-2 rounded-0">
                    ...
                    <div class="d-flex justify-content-between flex-wrap gap-2">
                        ...
                        <p class="fw-bold">
                            Total: <span class="text-warning" id="total-vehicles"></span> Vehicle
                        </p>
                    </div>
                ...
                <div class="modal-footer justify-content-navbar">
                    ...
                    <button type="button"  class="btn btn-custom-save" data-dismiss="modal" id="vehicle_submit"><i
    ...
    <script>
        $('#add-vehicle').on('click',function (){
           ...
           var port_id = $('#port').val();
            $.ajax({
                url: `/get-vehicles/${client_id}/${port_id}`, // Adjust the endpoint as needed
                type: 'GET',

                success: function(data) {
                    if (data['value'] === 1) {
                        $('#add-vehicles-body').html(data['view'])
                        $('#total-vehicles').html(data['number'])
                    }
        ...
        $('#vehicle_submit').on('click', function(event) {
            ...
            formData.append('vehicles[]',$('#ids').val())

            // Send AJAX request
            $.ajax({
                url: '/insert-vehicles', // Replace with your server-side upload URL
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
                ...
                success: function(response) {
                    ...
                    $('#insert-vehicles').html(response['view'])
