...
<div class="row mb-6">
    ...
    <div class="col-lg-4 fv-row">
        <!--begin::Label-->
        <label
            class="col-form-label fw-bold fs-6 required">{{ __('warehouse::view.company_name') }}</label>
        <!--end::Label-->
...
<div class="form-group">
    <!--begin::Label-->
    <label class="col-form-label fw-bold fs-6 required">{{ __('warehouse::view.booking_emails') }}</label>
    <!--end::Label-->
    <select
        ...
        <div class="row mb-6">
            ...
            <div class="col-lg-3 fv-row">
                ...
                <div class="input-group mb-4">
                    ...
                    <i id="check" class="far fa-eye" id="togglePassword" style="cursor: pointer;position: absolute;right: 0;padding:6%;font-size: 16px;"></i>
                    @error('password')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="col-lg-3 fv-row">
                <!--begin::Label-->
                <label class="col-form-label fw-bold fs-6 @if($typeForm == 'create') required @endif">{{ __('warehouse::view.password_confirmation') }}</label>
                <!--end::Label-->
                <div class="input-group mb-4">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><i class="fas fa-lock"></i></span>
                    </div>
                    <input type="password" id="password_confirmation" name="password_confirmation" class="form-control form-control-lg has-feedback @error('password_confirmation') is-invalid @enderror" placeholder="{{ __('warehouse::view.password_confirmation') }}"  />
                    @error('password')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
