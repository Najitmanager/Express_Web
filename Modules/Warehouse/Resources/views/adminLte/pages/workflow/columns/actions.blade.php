...
<div class="btn-group" role="group" aria-label="Actions">
    ...
    <div class="dropdown-menu custom-drodown-content" aria-labelledby="dropdownMenuButton">
        ...
        @if (/*auth()->user()->can('edit-currencies') ||*/ $user_role == $admin)
            <div>
                <a href="#" data-href="{{ fr_route('ports.edit', $model->id) }}" class="btn btn-sm btn-action-table px-3" id="edit-{{ $model->id }}"
        ...
        {{--    @if ($model->id != 1) --}}
        <div>
            <button type="button" data-action="{{ fr_route('ports.destroy', $model->id) }}"
