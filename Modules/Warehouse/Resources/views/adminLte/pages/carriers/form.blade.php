...
<div class="row mb-6">
    <!--begin::Label-->
    <label
        class="col-lg-4 col-form-label required fw-bold fs-6">{{ __('warehouse::view.carrier_name') }}</label>
    <!--end::Label-->
...
<div class="row mb-6">
    <!--begin::Label-->
    <label
        class="col-lg-4 col-form-label required fw-bold fs-6">{{ __('warehouse::view.tracking_url') }}</label>
    <!--end::Label-->
