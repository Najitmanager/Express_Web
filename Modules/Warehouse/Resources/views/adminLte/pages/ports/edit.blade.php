...
@section('pageTitle')
    {{ __('warehouse::view.edit_port') }} - {{$model->name}}
@endsection
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header">
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">{{ __('warehouse::view.edit_port') }}</h3>
            </div>
            <!--end::Card title-->
        ...
        <div>
            <!--begin::Form-->
            <form id="kt_account_profile_details_form" class="form" action="{{ fr_route('ports.update', ['id' => $model->id]) }}" method="post" enctype="multipart/form-data">
                @method('PUT')
                <!--begin::Card body-->
